...
//Var
unsigned char ADS1298R_REG[26];		//ADS1298R閿熶茎杈炬嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷�
unsigned char buff[27]={};
unsigned char ADS1298R_Cache[26];	//閿熸枻鎷烽敓鎹蜂紮鎷烽敓鏂ゆ嫹閿熸枻鎷�
...
//volatile unsigned char ADS1298R_recive_flag=0;	//閿熸枻鎷烽敓鎹疯鎷峰彇閿熸枻鎷锋潃閿熻锟�
//volatile unsigned char ADS1298R_Cache[26];	//閿熸枻鎷烽敓鎹蜂紮鎷烽敓鏂ゆ嫹閿熸枻鎷�
...
////				ADS1298R_Read_Data((INT8U*)ADS1298R_Cache);//閿熸枻鎷烽敓鎹峰瓨鍒�9閿熻鑺備紮鎷烽敓鏂ゆ嫹閿熸枻鎷�
...
void ADS1298R_Read_Data(unsigned char *data)//72M鏃堕敓鏂ゆ嫹閿熼摪鐚存嫹閿熸枻鎷烽敓鏂ゆ嫹鏃堕敓鏂ゆ嫹绾�10us  8M鏃堕敓鏂ゆ嫹閿熸枻鎷� 閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷锋椂閿熸枻鎷风害 100us
{		
//		unsigned char i;
//		uint8_t txdata=0x00;
		uint8_t txdata[27]={0};
...
//		ADS1298R_SET_REGBUFF();//閿熸枻鎷烽敓鐭瘎杈炬嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷�
//		ADS1298R_WR_REGS(WREG|CONFIG1,11,ADS1298R_REG+1);//閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鍙揪鎷烽敓渚ヨ揪鎷烽敓鏂ゆ嫹
//		DelayMs(10);		
//		ADS1298R_WR_REGS(RREG|ID,12,REG_Cache);//閿熸枻鎷烽敓渚ヨ揪鎷烽敓鏂ゆ嫹
//		DelayMs(10);	
//		
...
void ADS1298R_Single_Test(void) //娉ㄩ敓鏂ゆ嫹1292R閿熸枻鎷烽敓鍓跨尨鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閫氶敓鏂ゆ嫹涓�閿熸枻鎷烽敓鑺傝鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鑴氬彿璇ф嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸帴甯嫹娆わ拷閿熸枻鎷烽敓鏂ゆ嫹鍙敓杞垮尅鎷烽�氶敓鏂ゆ嫹2閿熸枻鎷烽敓缂达綇鎷�1292閿熸枻鎷烽敓鏂ゆ嫹褰遍敓鏂ゆ嫹
{
//		unsigned char res=0;
//		ADS1298R_Config2.Int_Test = INT_TEST_ON;//閿熸枻鎷烽敓鑺傝鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鑴氱尨鎷�
//		ADS1298R_Ch1set.MUX=MUX_Test_signal;//閿熸枻鎷烽敓鏂ゆ嫹閿熻剼鐚存嫹閿熸枻鎷烽敓鏂ゆ嫹
//		ADS1298R_Ch2set.MUX=MUX_Test_signal;//閿熸枻鎷烽敓鏂ゆ嫹閿熻剼鐚存嫹閿熸枻鎷烽敓鏂ゆ嫹
//		
//		if(ADS1298R_WRITE_REGBUFF())//鍐欓敓鏂ゆ嫹鎷囬敓鏂ゆ嫹閿燂拷
//				res=1;
//		DelayMs(10);
//		return res;		
}
...
{
//		unsigned char res=0;
//		ADS1298R_Config2.Int_Test = INT_TEST_OFF;//閿熸枻鎷烽敓鑺傝鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鑴氱尨鎷�
//		ADS1298R_Ch1set.MUX = MUX_input_shorted;//閿熸枻鎷烽敓鏂ゆ嫹閿熼摪锟�
//		ADS1298R_Ch2set.MUX = MUX_input_shorted;//閿熸枻鎷烽敓鏂ゆ嫹閿熼摪锟�
...
//		delay_us(1000);
		HAL_Delay(20);
		ADS1298R_Send_CMD(RDATAC); 	//閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹妯″紡
		HAL_Delay(20);
//		ADS1298R_Send_CMD(START);	//閿熸枻鎷烽敓閰靛尅鎷峰閿熸枻鎷烽敓鏂ゆ嫹杞敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹鏁堥敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹START閿熸枻鎷烽敓鑴氾綇鎷�
//		delay_us(10);
//		SPI_FLASH_CS_HIGH();
}

//閿熸枻鎷烽敓鏂ゆ嫹ADS1298R閿熺即纭锋嫹閿熸枻鎷峰紡
