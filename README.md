# PHYSIO FOR RODENT (not completed yet)

## PHYSIO HARDWARE  
1.ECG + Respiration  
2.SPO2  
3.Temperature  
4.Heater (For maintaining animal's temperature)  
5.Blood pressure  
6.Data output (Wire and wireless)  

## KNOWLEDGE Required
1.Hardware  
2.ST MCU programme  
3.ESP32 programme  
4.Pid control for heater  
5.algorithm for calculating ecg spo2 etc.  
